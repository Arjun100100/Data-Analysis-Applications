...
def main():
    ...
    st.write("Customer_ID INT,	Bank_Name STRING,	Investment_Year STRING,	Investment_Type STRING,	Capital_Invested INT,	Current_Value_of_Investment INT,	Interest_Rate FLOAT,	Return_on_Investment FLOAT")
    ...
    if uploaded_file is not None:
        ...
        st.write("1. Which bank has the highest average overall return on investment (ROI) across all years?")
